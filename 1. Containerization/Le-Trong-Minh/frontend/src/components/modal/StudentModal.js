...
const StudentModal = (props) => {
  ...
  const handleSubmit = (newData) => {
    ...
    apiCall
      .then(() => {
        const successMessage = id === "" ? "Add student successfully!" : "Update student successfully!";
        ...
        <Spin spinning={loading} size='large'>
          <Row gutter={[24, 24]}>
            <Col span={12}>
              ...
              >
                <Input disabled={!isEdit} placeholder={"Order"} />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Input disabled={!isEdit} placeholder={"Input fullname"} />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Input disabled={!isEdit} placeholder='Username' />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Input disabled={!isEdit} placeholder='Date of Birth' />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Input disabled={!isEdit} placeholder='Nhập trường đại học' />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
